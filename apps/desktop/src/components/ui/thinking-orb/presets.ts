...
export const PRESETS: Record<ModeKey, Record<OrbSize, Preset>> = {
  orbits: {
    72: { speed: 1.885, count: 1, size: 1 },
    96: { speed: 1.885, count: 1, size: 1 },
    64: { speed: 1.885, count: 1, size: 1 },
    20: { speed: 3.9, count: 0.238, size: 2.4 }
  },
  globe: {
    72: { speed: 2.015, count: 0.42, size: 1.15, extra: { scanMul: 4.08, dimBase: 0.45 } },
    96: { speed: 2.015, count: 0.42, size: 1.15, extra: { scanMul: 4.08, dimBase: 0.45 } },
    64: { speed: 2.015, count: 0.42, size: 1.15, extra: { scanMul: 4.08, dimBase: 0.45 } },
    20: { speed: 2.665, count: 0.105, size: 1.75, extra: { scanMul: 4.335, dimBase: 0.45 } }
  },
  rubik: {
    72: { speed: 1.82, count: 0.35, size: 1.05 },
    96: { speed: 1.82, count: 0.35, size: 1.05 },
    64: { speed: 1.82, count: 0.35, size: 1.05 },
    20: { speed: 1.95, count: 0.088, size: 1.9 }
  },
  wave: {
    72: { speed: 4.388, count: 0.341, size: 1 },
    96: { speed: 4.388, count: 0.341, size: 1 },
    64: { speed: 4.388, count: 0.341, size: 1 },
    20: { speed: 3.998, count: 0.105, size: 1.6 }
  },
  web: {
    72: { speed: 3.315, count: 1.35, size: 0.95 },
    96: { speed: 3.315, count: 1.35, size: 0.95 },
    64: { speed: 3.315, count: 1.35, size: 0.95 },
    20: { speed: 6.63, count: 0.25, size: 1.52 }
  },
  braid: {
    72: { speed: 1.625, count: 0.5, size: 1 },
    96: { speed: 1.625, count: 0.5, size: 1 },
    64: { speed: 1.625, count: 0.5, size: 1 },
    20: { speed: 2.75, count: 0.1125, size: 1.36 }
  },
  ribbon: {
    72: { speed: 2.34, count: 0.25, size: 0.85, extra: { spin: 0, bandMul: 3.9, wobMul: 1 } },
    96: { speed: 2.34, count: 0.25, size: 0.85, extra: { spin: 0, bandMul: 3.9, wobMul: 1 } },
    64: { speed: 2.34, count: 0.25, size: 0.85, extra: { spin: 0, bandMul: 3.9, wobMul: 1 } },
    20: { speed: 3.12, count: 0.051, size: 1.073, extra: { spin: 0, bandMul: 4.94, wobMul: 1 } }
  },
  ring: {
    72: { speed: 3.24, count: 0.25, size: 0.956, extra: { spin: 0, bandMul: 3.627, wobMul: 0.368 } },
    96: { speed: 3.24, count: 0.25, size: 0.956, extra: { spin: 0, bandMul: 3.627, wobMul: 0.368 } },
  ...
  morph: {
    72: { speed: 2.405, count: 0.702, size: 0.395, extra: { spread: 1.45 } },
    96: { speed: 2.405, count: 0.702, size: 0.395, extra: { spread: 1.45 } },
