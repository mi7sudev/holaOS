...
/**
 * Rendered size in CSS pixels. Three tuned presets ship:
 * 96 (large chat-scale), 64 (chat-avatar scale) and 20 (inline-text
 * scale). Each size carries its own dot count, dot size and speed
 * tuning — they are separate designs, not a scale factor.
 */
export type OrbSize = 64 | 72 | 96 | 20;
